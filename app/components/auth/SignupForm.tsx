  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="mt-1 text-on-surface-variant">Join EcoMarket and start shopping sustainably.</p>
      </div>
            ...
            <div className="flex rounded-full border border-outline-variant bg-surface p-0.5 text-xs font-semibold">
              <button
                ...
                className={`rounded-full px-3 py-1 transition-colors ${
                  contactMethod === "email" ? "bg-primary text-white" : "text-on-surface-variant hover:text-foreground"
                }`}
              >
                Email
              </button>
              <button
                ...
                className={`rounded-full px-3 py-1 transition-colors ${
                  contactMethod === "phone" ? "bg-primary text-white" : "text-on-surface-variant hover:text-foreground"
                }`}
              >
                Phone
              </button>
